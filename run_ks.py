...
CACHE_FILES = {
    ...
    14.0: (
        CACHE_ROOT / "z14.0" / "d1s_fiducial_real10.npz",
        CACHE_ROOT / "z14.0" / "d1s_stochastic_real10.npz",
    ),
}
...
REDSHIFT_CONFIGS = {
    8.0:  RedshiftConfig(redshift=8.0,  halo_catalog_path=Path(f"{_CACHE_BASE}/1955/{_HASH}/8.0000/HaloCatalog.h5"),  muv_fiducial_path=Path("/lustre/astro/ivannik/catalog_fiducial_bigger_z8n.h5"),          muv_stochastic_path=Path("/lustre/astro/ivannik/catalog_stoch_bigger_z8_sigmaUVb_06_fullres.h5")),
    ...
    14.0: RedshiftConfig(redshift=14.0, halo_catalog_path=Path(f"{_CACHE_BASE}/1955/{_HASH}/14.0000/HaloCatalog.h5"), muv_fiducial_path=Path("/lustre/astro/ivannik/catalog_fiducial_bigger_z14_10_n_Muvadd18_210926.h5"),        muv_stochastic_path=Path("/lustre/astro/ivannik/catalog_stoch_bigger_z14_10_ns_lowres_sigmab07_210926.h5")),
}

N_REALIZATIONS = {8.0: 2, 10.5: 20, 12.0: 100, 14.0: 10}
# ---------------------------------------------------------------------------
