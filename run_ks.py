...
CACHE_FILES = {
    ...
    14.0: (
        CACHE_ROOT / "z14.0" / "d1s_fiducial_real50.npz",
        CACHE_ROOT / "z14.0" / "d1s_stochastic_real50.npz",
    ),
}
...
REDSHIFT_CONFIGS = {
    ...
    14.0: RedshiftConfig(redshift=14.0, halo_catalog_path=Path(f"{_CACHE_BASE}/1955/{_HASH}/14.0000/HaloCatalog.h5"), muv_fiducial_path=Path("/lustre/astro/ivannik/catalog_fiducial_bigger_z14_100_n_Muvadd18_210926.h5"),        muv_stochastic_path=Path("/lustre/astro/ivannik/catalog_stoch_bigger_z14_100_ns_lowres_sigmab09_250926.h5")),
}
