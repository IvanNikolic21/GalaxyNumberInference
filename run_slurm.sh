...
#python run_analysis.py --redshift 10.5 --muv-realizations 5 --force-recompute
python run_analysis.py --redshift 10.5 --muv-realizations 10 --force-recompute

# z=8
python run_analysis.py --redshift 8.0 --muv-realizations 2 --force-recompute

# z=12
python run_analysis.py --redshift 12.0 --muv-realizations 100 --force-recompute
