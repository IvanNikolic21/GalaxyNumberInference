...
REDSHIFT_CONFIGS = {
    ...
    14.0: RedshiftConfig(
        ...
        muv_fiducial_path=Path("/lustre/astro/ivannik/catalog_fiducial_bigger_z14p0_1000.h5"),
        muv_stochastic_path=Path("/lustre/astro/ivannik/catalog_stoch_bigger_z14p0_1000.h5"),
    ),
}
